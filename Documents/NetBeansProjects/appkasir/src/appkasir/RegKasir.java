 ...
 * @author ASUS
 */
public class RegKasir extends javax.swing.JFrame {

    /**
     * Creates new form RegKasir
     */
    public RegKasir() {
        initComponents();
    }
    ...
    private void suActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suActionPerformed
       Koneksi con = new Koneksi();
        con.config();
        try{
            String sql = "INSERT INTO kasir (username, password) VALUES ( '" + usr.getText() + "', '" + pw.getText() +"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegKasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
